...
class Attendance:
   ...
   #========VAriables====
        ...
        #First Image
        img=Image.open(r"college_images\stud1.jpg")
        ...
        img1=Image.open(r"college_images\stud2.jpg")
        ...
        save_btn=Button(btn_frame,text="Import csv",command=self.importCsv,width=17,font=("times now roman",13,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0) 

        update_btn=Button(btn_frame,text="Export csv",command=self.exportCsv,width=17,font=("times now roman",13,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)      

        delete_btn=Button(btn_frame,text="Update",width=17,font=("times now roman",13,"bold"),bg="blue",fg="white")
