...
class Student:
    def __init__(self,root):
        ...
        #First Image
        img=Image.open(r"C:\Users\hp\Desktop\Face_Recognition\college_images\student1.jpg")
        ...
        img1=Image.open(r"C:\Users\hp\Desktop\Face_Recognition\college_images\student2.jpg")
        ...
        img2=Image.open(r"C:\Users\hp\Desktop\Face_Recognition\college_images\student3.jpg")
        ...
        #BG image
        img3=Image.open(r"C:\Users\hp\Desktop\Face_Recognition\college_images\bgimg.jpg")
        ...
        img_left=Image.open(r"C:\Users\hp\Desktop\Face_Recognition\college_images\student4.jpg")
        ...
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=17,font=("times now roman",13,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0) 

        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=17,font=("times now roman",13,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)      

        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=17,font=("times now roman",13,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2) 

        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=17,font=("times now roman",13,"bold"),bg="blue",fg="white")
        reset_btn.grid(row=0,column=3) 

        btn_frame1=Frame(class_Student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=235,width=715,height=35)

        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=35,font=("times now roman",13,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0) 

        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",width=35,font=("times now roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\hp\Desktop\Face_Recognition\college_images\student5.jpg")
        ...
        search_btn=Button(Search_frame,text="Search",width=12,font=("times now roman",12,"bold"),bg="blue",fg="white")
        search_btn.grid(row=0,column=3,padx=4) 

        showAll_btn=Button(Search_frame,text="Show All",width=12,font=("times now roman",12,"bold"),bg="blue",fg="white")
...
#Table frame
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='Tellingc',database='face_recognizer')  
