...
#Detect Face
        ...
        #Photos Face  Button
        img09=Image.open(r"college_images\photy.jpg")
        img09=img09.resize((220,220),Image.ANTIALIAS)
        self.photoimg09=ImageTk.PhotoImage(img09)


        b1=Button(bg_img,image=self.photoimg09,cursor="hand2",command=self.open_img)
        ...
        #Developer Button
        img9=Image.open(r"college_images\developer1.jpg")
